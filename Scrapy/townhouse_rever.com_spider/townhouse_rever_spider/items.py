...
class ApartmentItem(Item):
    ...
    land_area = Field(input_processor=MapCompose(clean_input), output_processor=TakeFirst())
    floor_area = Field(input_processor=MapCompose(clean_input), output_processor=TakeFirst())
